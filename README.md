...
1. **Write a SQL query to retrieve all columns for sales made on '2022-08-05**:
```sql
SELECT *
FROM retail
WHERE sale_date = '2022-08-05';
```
...
- **LinkedIn**: [Connect with me professionally](https://www.linkedin.com/in/deeraj-pv-aa6b31336)
